<div class="container">
            ...
            <div class="text-center">
                <ul class="nav nav-pills filter-btns justify-content-center" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-medium active" type="button" data-filter="all">All</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-medium" type="button" data-filter="laravel">Laravel</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-medium" type="button" data-filter="net">.Net Framework</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-medium" type="button" data-filter="nodejs">Node Js</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-medium" type="button" data-filter="reactjs">React Js</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-medium" type="button" data-filter="vuejs">Vue Js</button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-6 product-item reactjs laravel">
            <div class="card explore-box card-animate">
                <div class="card-body">
                    <img src="{{asset('assets/images/simple_crud_posts/02_list.png')}}" alt="" class="img-fluid rounded" />
                </div>
                <div class="card-body">
                    <ul class="list-inline fs-14 text-muted">
                        <li class="list-inline-item">
                            <i class="ri-checkbox-circle-line align-bottom me-1"></i>Laravel & React Js
                        </li>
                    </ul>
                    <a href="javascript:void(0);">
                        <h5>Simple CRUD - Posts</h5>
                    </a>
                    <p class="text-muted fs-14">This is a web application about Simple CRUD - Posts.</p>
                    <div>
                        <a href="javascript:void(0);" class="link-success" data-bs-toggle="modal" data-bs-target=".simple-crud-posts">Learn More <i class="ri-arrow-right-line align-bottom ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 product-item laravel">
            <div class="card explore-box card-animate">
                <div class="card-body">
                    <img src="{{asset('assets/images/pdf_image/01_conv.png')}}" alt="" class="img-fluid rounded" />
                </div>
                <div class="card-body">
                    <ul class="list-inline fs-14 text-muted">
                        <li class="list-inline-item">
                            <i class="ri-checkbox-circle-line align-bottom me-1"></i>PHP, Laravel, Canvas & PDF
                        </li>
                    </ul>
                    <a href="javascript:void(0);">
                        <h5>Generate PDF & Image</h5>
                    </a>
                    <p class="text-muted fs-14">This is a web application about Generate PDF to Send Email & HTML 2 Canvas.</p>
                    <div>
                        <a href="javascript:void(0);" class="link-success" data-bs-toggle="modal" data-bs-target=".pdf-image">Learn More <i class="ri-arrow-right-line align-bottom ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade ecommerce" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel"><i class="ri-award-fill align-bottom me-1 text-primary"></i> Ecommerce </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-5">
                        <p class="fs-14 text-muted">
                            This is a web application about Ecommerce Business. This application is the result of me take <strong>Online Classes In Build With Angga</strong>, this application has features : 
                        </p>
                        <hr class="text-muted">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Login and Register User.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p class="text-muted mb-0 fs-14">Dashboard User : <strong>Product Settings for Sale, View Transaction, Store Settings and Account Settings.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p class="text-muted mb-0 fs-14">Dashboard Admin : <strong>Product Settings, Image Product, Categories, View Transactions and Users Settings.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p class="text-muted mb-0 fs-14"><strong>Show Product, Detail Product and CheckOut Product.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p class="text-muted mb-0 fs-14"><strong>Payment with Midtrans.</strong></p>
                            </div>
                        </div>
                        <p class="mb-2">
                            <span class="text-primary">Languages and Tools :</span> 
                            <div class="hstack gap-2 mb-2">
                                ...
                                <span class="badge badge-soft-primary">JQuery</span>
                                <span class="badge badge-soft-primary">CKEditor</span>
                                <span class="badge badge-soft-primary">Midtrans</span>
                        ...
                        <div class="card bg-soft-dark">
                            <div class="card-body">
                                ...
                                <div class="swiper pagination-fraction-swiper rounded">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/01_utama.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/01_utama2.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/02_detail.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/02_detail2.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/03_cart.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/03_cart2.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/04_dashboard.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/05_admin.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/06_product.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/06_product2.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/ecommerce/login.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
...
<div class="modal fade simple-crud-posts" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel"><i class="ri-award-fill align-bottom me-1 text-primary"></i> Simple CRUD - Posts</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-5">
                        <p class="fs-14 text-muted">
                            This is a web application Simple CRUD - Posts with Laravel & React Js. This application is made for self learning, this application has features : 
                        </p>
                        <hr class="text-muted">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Create, Read, Update and Delete Data Posts.</p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Feature authentication with <strong>Laravel Sanctum.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0"><strong>Frontend with React Js.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0"><strong>Backend with Laravel to Send API to Front End.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0"><strong>With Local Storage to Save Temporary Token.</strong></p>
                            </div>
                        </div>
                        <p class="mb-2">
                            <span class="text-primary">Languages and Tools :</span> 
                            <div class="hstack gap-2 mb-2">
                                <span class="badge badge-soft-primary">Laravel</span>
                                <span class="badge badge-soft-primary">React Js</span>
                                <span class="badge badge-soft-primary">Laravel Sanctum</span>
                            </div>
                        </p>
                    </div>
                    <div class="col-lg-7">
                        <div class="card bg-soft-dark">
                            <div class="card-body">
                                ...
                                <div class="swiper pagination-fraction-swiper rounded">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/01_login.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/01_login_success.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/01_login_failed.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/02_list.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/03_add.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/04_update.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/simple_crud_posts/05_delete.png')}}" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="swiper-button-next bg-white shadow"></div>
                                    <div class="swiper-button-prev bg-white shadow"></div>
...
<div class="modal fade pdf-image" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel"><i class="ri-award-fill align-bottom me-1 text-primary"></i> PHP, Laravel & Canvas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-5">
                        <p class="fs-14 text-muted">
                            This is a web application about Generate PDF to Send Email & HTML 2 Canvas. This application is made for self learning, this application has features : 
                        </p>
                        <hr class="text-muted">
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Generate <strong>File Pdf.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Send email <strong>according with Input.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Send Email <strong>With attachment file Pdf from generate system.</strong></p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0"><strong>Generate / Screenshot</strong> page HTML to be image with html2canvas.</p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Button <strong>Set Text</strong> to according input text with image caption.</p>
                            </div>
                        </div>
                        <div class="d-flex mt-2 mb-2">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2 fs-14">
                                <p class="text-muted mb-0">Button <strong>Generate</strong> to download final result.</p>
                            </div>
                        </div>
                        <p class="mb-2">
                            <span class="text-primary">Languages and Tools :</span> 
                            <div class="hstack gap-2 mb-2">
                                <span class="badge badge-soft-primary">PHP</span>
                                <span class="badge badge-soft-primary">Laravel</span>
                                <span class="badge badge-soft-primary">HTML 2 Canvas</span>
                                <span class="badge badge-soft-primary">Generate PDF</span>
                            </div>
                        </p>
                    </div>
                    <div class="col-lg-7">
                        <div class="card bg-soft-dark">
                            <div class="card-body">
                                ...
                                <div class="swiper pagination-fraction-swiper rounded">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/01_conv.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/02_conv.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/03_download.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/04_result.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/01_generate_pdf_01.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/01_generate_multi2.png')}}" alt="" class="img-fluid" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/images/pdf_image/01_generate_multi.jpeg')}}" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="swiper-button-next bg-white shadow"></div>
                                    <div class="swiper-button-prev bg-white shadow"></div>
